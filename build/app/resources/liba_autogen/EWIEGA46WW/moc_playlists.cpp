...
QT_MOC_LITERAL(1, 10, 17), // "changePlaylistSig"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(4, 51, 14), // "elementClicked"
QT_MOC_LITERAL(5, 66, 11), // "QModelIndex"
QT_MOC_LITERAL(6, 78, 7), // "current"
QT_MOC_LITERAL(7, 86, 22), // "onPlaylistsContextMenu"
QT_MOC_LITERAL(8, 109, 5), // "point"
QT_MOC_LITERAL(9, 115, 15) // "func_for_delete"

    },
    "Playlists\0changePlaylistSig\0\0"
    "on_pushButton_clicked\0elementClicked\0"
    "QModelIndex\0current\0onPlaylistsContextMenu\0"
    "point\0func_for_delete"
};
...
void Playlists::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changePlaylistSig((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->on_pushButton_clicked(); break;
        case 2: _t->elementClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 3: _t->onPlaylistsContextMenu((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 4: _t->func_for_delete(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Playlists::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Playlists::changePlaylistSig)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Playlists::changePlaylistSig(int _t1)
{
